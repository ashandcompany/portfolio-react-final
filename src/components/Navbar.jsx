...
const Navbar = () => {
  ...
  return (
    <div className='fixed top-0 left-0 w-full py-4 px-6 backdrop-blur-md bg-white dark:bg-darkPink-light z-50 transition-colors duration-300'>
        <div className='max-w-[1300px] mx-auto  flex justify-between text-gray-200
        text-xl items-center px-12 h-20'>

            <a href="#" className='text-2xl font-bold text-pink-dark dark:text-pink-light'>J.Doe</a>
            ...
            >
                <ul className='text-gray-700 dark:text-pink-light hover:text-pink-dark dark:hover:text-pink transition-colors duration-300 font-medium'>
